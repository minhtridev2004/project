...
def register():
    ...
    #label
    Label(register_screen, text = "Nhập thông tin của bạn", font = ('Calibri, 12')).grid(row = 0, sticky = N, pady = 6)
    Label(register_screen, text = "Họ và Tên", font = ('Calibri, 12')).grid(row = 1, sticky = W)
    Label(register_screen, text = "Tuổi", font = ('Calibri, 12')).grid(row = 2, sticky = W)
    Label(register_screen, text = "Giới tính", font = ('Calibri, 12')).grid(row = 3, sticky = W)
    Label(register_screen, text = "Tên tài khoản", font = ('Calibri, 12')).grid(row = 4, sticky = W)
    Label(register_screen, text = "Mật khẩu", font = ('Calibri, 12')).grid(row = 5, sticky = W)
    ...
    #buttons
    Button(register_screen, text ="Đăng kí", command= finish_reg , font = ('Calibri', 12),bg="grey").grid(row = 6, stick = N, pady = 10)
...
def infor():
    ...
    #labels
    Label(infor_screen , text = "Thông tin cá nhân "+ details_name , font = ('Calibri', 12)).grid(row = 0, stick = N, pady = 10)
    Label(infor_screen , text = "\tTên tài khoản: "+ details_account , font = ('Calibri', 12)).grid(row = 1, stick = W)
    Label(infor_screen , text = "\tTên: "+ details_name , font = ('Calibri', 12)).grid(row = 2, stick = W)
    Label(infor_screen , text = "\tTuổi: "+ details_age , font = ('Calibri', 12)).grid(row = 3, stick = W)
    Label(infor_screen , text = "\tGiới Tính "+ details_gender , font = ('Calibri', 12)).grid(row = 4, stick = W)
    Label(infor_screen , text = "\tSố dư: "+ details_balance , font = ('Calibri', 12)).grid(row = 5, stick = W)
...
def login():
    ...
    # label
    Label(login_screeen, text = "Đăng nhập bằng tài khoản của bạn", font = ('Calibri', 12)).grid(row = 0, sticky= N,pady = 6)
    Label(login_screeen, text = "Tên tài khoản", font = ('Calibri', 12)).grid(row = 1, sticky= W)
    Label(login_screeen, text = "Mật khẩu", font = ('Calibri', 12)).grid(row = 2, sticky= W)
    ...
    # buttons
    Button(login_screeen, text ="Đăng nhập", command= login_session, width= 15 , font = ('Calibri', 12), bg="grey").grid(row = 3, stick = N, pady = 5, padx= 5)
#image
img = Image.open('project_python\image.jpg')
img = img.resize((150,150))
img =  ImageTk.PhotoImage(img)
#lable
Label(master, text="TN banking", font =('',14), width = 40).grid(row=0, sticky=N, pady=10)
